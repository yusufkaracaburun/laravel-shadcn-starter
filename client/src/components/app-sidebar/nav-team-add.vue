    ...
    <form class="space-y-4" @submit="onSubmit">
      <FormField v-slot="{ componentField }" name="name">
        <FormItem>
          ...
          <FormDescription> Set the name for the team. </FormDescription>
          <FormMessage />
        </FormItem>
      </FormField>
      <FormField v-slot="{ componentField }" name="slug">
        <FormItem>
          ...
          <FormDescription> Set the slug for the team. </FormDescription>
          <FormMessage />
        </FormItem>
      </FormField>
      <FormField v-slot="{ componentField }" name="logo">
        <FormItem>
          ...
          <FormDescription> Set the logo of the team. </FormDescription>
          <FormMessage />
        </FormItem>
      </FormField>
