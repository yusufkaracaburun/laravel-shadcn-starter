...
import TimesheetDelete from './timesheet-delete.vue'
import TimesheetEditDialog from './timesheet-edit-dialog.vue'

const props = defineProps<IDataTableRowActionsProps<ITimesheet>>()
const timesheet = computed(() => props.row.original)
...
function handleSelect(command: TCommand) {
  switch (command) {
    case 'view':
      ...
      // router.push({
      //   name: '/timesheets/view/[id]',
      //   params: { id: timesheet.value.id.toString() },
      // })
      break
    case 'edit':
      ...
      break
    case 'delete':
      showComponent.value = TimesheetDelete
      break
  }
}
