...
const errorSubtitle = computed(() => {
  ...
  return 'Error Loading Vehicle'
})

const errorText = computed(() => {
  if (isNotFound.value) {
    return 'The vehicle you are looking for might have been removed or doesn\'t exist.'
  }
  return 'An error occurred while loading the vehicle information. Please try again.'
})
</script>
