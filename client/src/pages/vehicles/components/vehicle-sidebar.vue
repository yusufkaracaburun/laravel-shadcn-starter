...
import InspectorPanelSection
  from '@/components/global-layout/components/inspector-panel-section.vue'
import InspectorPanel from '@/components/global-layout/components/inspector-panel.vue'
...
<template>
  ...
  >
    <!-- Time Section -->
    <InspectorPanelSection title="Time" title-spacing="lg">
    ...
    <InspectorPanelSection title="Vehicle Info" with-border>
