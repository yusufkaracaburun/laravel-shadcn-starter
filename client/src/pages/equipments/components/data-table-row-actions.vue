...
import EquipmentsDelete from './equipments-delete.vue'
import EquipmentsEditDialog from './equipments-edit-dialog.vue'

const props = defineProps<IDataTableRowActionsProps<IEquipment>>()
const equipment = computed(() => props.row.original)
...
function handleSelect(command: TCommand) {
  switch (command) {
    case 'view':
      ...
      // router.push({
      //   name: '/equipments/view/[id]',
      //   params: { id: equipment.value.id.toString() },
      // })
      break
    case 'edit':
      ...
      break
    case 'delete':
      showComponent.value = EquipmentsDelete
      break
  }
}
