...
const errorText = computed(() => {
  if (isNotFound.value) {
    return 'The company you are looking for might have been removed or doesn\'t exist.'
  }
  return 'An error occurred while loading the company information. Please try again.'
})
</script>
