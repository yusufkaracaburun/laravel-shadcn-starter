<script lang="ts" setup generic="T = Company">
...
function handleConfirm() {
  ...
  toast.promise(new Promise((resolve) => setTimeout(resolve, 2000)), {
    ...
    success: () => {
      ...
      return `Successfully deleted ${selectedRows.value.length} companies.`
    },
...
<template>
  ...
  >
    <template #title> Delete {{ selectedCount }} companies? </template>
    <template #description>
      Are you sure you want to delete the selected companies? <br />
