...
const errorText = computed(() => {
  if (isNotFound.value) {
    return 'The item you are looking for might have been removed or doesn\'t exist.'
  }
  return 'An error occurred while loading the item information. Please try again.'
})
</script>
