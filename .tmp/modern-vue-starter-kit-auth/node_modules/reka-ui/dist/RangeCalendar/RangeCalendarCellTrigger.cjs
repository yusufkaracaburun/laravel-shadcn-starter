		...
		function handleArrowKey(e) {
			...
			function shiftFocus(node, add) {
				...
				if (newIndex >= 0 && newIndex < allCollectionItems.length) {
					...
					const newDateValue = require_date_comparators.parseStringToDateValue(newDate, rootContext.placeholder.value);
				...
				if (newIndex < 0) {
					...
					(0, vue.nextTick)(() => {
						...
						if (!rootContext.pagedNavigation.value && rootContext.numberOfMonths.value > 1) {
							...
							rootContext.onPlaceholderChange(require_date_comparators.parseStringToDateValue(newDate$1, rootContext.placeholder.value));
						...
						rootContext.onPlaceholderChange(require_date_comparators.parseStringToDateValue(newDate, rootContext.placeholder.value));
