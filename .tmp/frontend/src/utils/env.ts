...
// Export API base URL for convenience (with fallback)
export const VITE_API_BASE_URL = env?.VITE_API_BASE_URL || import.meta.env.VITE_API_BASE_URL || 'http://127.0.0.1:8000'
