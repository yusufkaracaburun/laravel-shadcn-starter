            ...
            switch (pseudo.name) {
                ...
                case 'where':
                    if (!pseudo.arguments) {
                        ...
                        throw new element[PropertySymbol.window].DOMException(`Failed to execute 'matches' on '${element.constructor.name}': '${this.getSelectorString()}' is not a valid selector.`);
                    }
                    break;
            }
