...
export default class HTMLParser {
    ...
    isTemplateDocumentFragment = false;
    rootNode = null;
    rootDocument = null;
    nodeStack = [];
    tagNameStack = [];
    ...
    parseEndOfStartTag(attributeString, isSelfClosed) {
        ...
        while (previousCurrentNode !== this.rootNode) {
            ...
            else if (!this.isTemplateDocumentFragment &&
    ...
    parseRawTextElementContent(tagName, text) {
        ...
        if (upperTagName === 'SCRIPT') {
            this.currentNode[PropertySymbol.disableEvaluation] =
            ...
            this.currentNode[PropertySymbol.disableEvaluation] = !this.evaluateScripts;
        }
