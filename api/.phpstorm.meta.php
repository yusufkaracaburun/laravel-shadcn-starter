...
'logging.channels.pail.driver','logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days',
'login-link.enabled','login-link.rate_limit_attempts','login-link.rate_limit_decay','login-link.expiration_minutes','mail.default',
...
'boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','query-builder.parameters.include','query-builder.parameters.filter',
...
'SANCTUM_STATEFUL_DOMAINS','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE',
'CACHE_PREFIX','CACHE_DEFAULT_TTL','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
...
'RESEND_KEY','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET',
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET','GOOGLE_CLIENT_ID',
'GOOGLE_CLIENT_SECRET','GITLAB_CLIENT_ID','GITLAB_CLIENT_SECRET','STRIPE_KEY','STRIPE_SECRET',
'STRIPE_WEBHOOK_SECRET','SENTRY_LARAVEL_DSN','GEMINI_API_KEY','BROADCAST_CONNECTION','REVERB_APP_ID',
'REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME',
'VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','SLACK_WEBHOOK_URL',
'OPENAI_API_KEY','TRANSLATION_DEFAULT_DRIVER','TRANSLATION_SOURCE_LANGUAGE','CHATGPT_API_KEY','GOOGLE_API_KEY',
'DEEPL_API_KEY','ANTHROPIC_API_KEY','PHONE_DEFAULT_REGION','QUERY_DETECTOR_ENABLED','QUERY_DETECTOR_THRESHOLD',
'QUERY_DETECTOR_LOG_CHANNEL','LARAVEL_PDF_CHROME_PATH',);
