...
'logging.channels.emergency.path','logging.channels.pail.driver','logging.channels.deprecations.driver','logging.channels.deprecations.handler','logging.channels.browser.driver',
'logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','login-link.enabled','login-link.rate_limit_attempts',
'login-link.rate_limit_decay','login-link.expiration_minutes','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'media-library.force_lazy_loading','money.locale','money.defaultCurrency','money.defaultFormatter','money.defaultSerializer',
'money.isoCurrenciesPath','money.currencies.iso','money.currencies.bitcoin','money.currencies.custom','oauth.providers.0.slug',
'oauth.providers.0.active','oauth.providers.0.icon','oauth.providers.1.slug','oauth.providers.1.active','oauth.providers.1.icon',
'oauth.providers.2.slug','oauth.providers.2.active','oauth.providers.2.icon','oauth.providers.3.slug','oauth.providers.3.active',
'oauth.providers.3.icon','oauth.providers.4.slug','oauth.providers.4.active','oauth.providers.4.icon','oauth.providers.5.slug',
'oauth.providers.5.active','oauth.providers.5.icon','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.github.client_id',
'services.github.client_secret','services.github.redirect','services.google.client_id','services.google.client_secret','services.google.redirect',
'services.x.client_id','services.x.client_secret','services.x.redirect','services.gitlab.client_id','services.gitlab.client_secret',
'services.gitlab.redirect','services.bitbucket.client_id','services.bitbucket.client_secret','services.bitbucket.redirect','services.discord.client_id',
'services.discord.client_secret','services.discord.redirect','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','spy.enabled','spy.table_name',
'spy.db_connection','spy.exclude_urls','spy.obfuscates','spy.obfuscation_mask','spy.clean_days',
'spy.request_body_exclude_content_types','spy.response_body_exclude_content_types','spy.field_max_length','spy.field_max_rows','spy.dashboard.enabled',
'spy.dashboard.prefix','spy.dashboard.middleware','telescope.enabled','telescope.domain','telescope.path',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','view.paths','view.compiled','boost.enabled','boost.browser_logs_watcher',
...
'query-builder.disable_invalid_includes_query_exception','query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','tinker.commands',
...
'SESSION_PATH','SESSION_SAME_SITE','SESSION_SECURE_COOKIE','SESSION_DOMAIN','SANCTUM_STATEFUL_DOMAINS',
...
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','RESEND_KEY',
...
'ANTHROPIC_API_KEY','PHONE_DEFAULT_REGION',);
