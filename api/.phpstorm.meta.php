...
'cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','concurrency.default','cors.paths',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.pail.driver','logging.channels.browser.driver','logging.channels.browser.path',
'logging.channels.browser.level','logging.channels.browser.days','login-link.enabled','login-link.rate_limit_attempts','login-link.rate_limit_decay',
'login-link.expiration_minutes','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','oauth.providers.0.slug',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','view.paths','view.compiled','boost.enabled',
'boost.browser_logs_watcher','mcp.redirect_domains','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','RESEND_KEY',
'AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT',
'VITE_APP_NAME','OCTANE_SERVER','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET','GOOGLE_CLIENT_ID',
