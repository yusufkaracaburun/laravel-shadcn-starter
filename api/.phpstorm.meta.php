...
'boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','media-library.disk_name','media-library.max_file_size',
...
'media-library.enable_vapor_uploads','media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','tinker.commands',
...
'api.users.user.index','api.users.user.store','api.users.user.show','api.users.user.update','api.users.user.destroy',
'api.teams.teams.index','api.teams.teams.store','api.teams.teams.show','api.teams.teams.update','api.teams.teams.destroy',
'api.teams.switch','oauth.redirect','oauth.callback','login-link.store',
'login-link.login','oauth.destroy','storage.local',);
