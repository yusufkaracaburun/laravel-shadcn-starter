    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Repositories\Contracts\ItemRepositoryInterface' => \App\Repositories\Concretes\ProductRepository::class,
            ...
            'App\Services\Contracts\ItemServiceInterface' => \App\Services\Concretes\ProductService::class,
...
'password.confirm.store','resend.webhook','api.users.current',
...
'api.companies.company.store','api.companies.company.show','api.companies.company.update','api.companies.company.destroy','api.projects.project.index',
'api.projects.project.store','api.projects.project.show','api.projects.project.update','api.projects.project.destroy','api.invoices.prerequisites',
'api.invoices.invoices.preview-pdf','api.invoices.download-pdf','api.invoices.invoices.index','api.invoices.invoices.store','api.invoices.invoices.show',
'api.invoices.invoices.update','api.invoices.invoices.destroy','api.items.items.index','api.items.items.store','api.items.items.show',
'api.items.items.update','api.items.items.destroy','api.payments.payments.index','api.payments.payments.store','api.payments.payments.show',
'api.payments.payments.update','api.payments.payments.destroy','api.customers.customers.index','api.customers.customers.store','api.customers.customers.show',
'api.customers.customers.update','api.customers.customers.destroy','api.permissions.permissions.index','api.permissions.permissions.store','api.permissions.permissions.show',
'api.permissions.permissions.update','api.permissions.permissions.destroy','api.roles.roles.index','api.roles.roles.store','api.roles.roles.show',
'api.roles.roles.update','api.roles.roles.destroy','oauth.redirect','oauth.callback',
'login-link.store','login-link.login','oauth.destroy','storage.local',);
