...
'media-library.enable_vapor_uploads','media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','money.locale',
'money.defaultCurrency','money.defaultFormatter','money.defaultSerializer','money.isoCurrenciesPath','money.currencies.iso',
'money.currencies.bitcoin','money.currencies.custom','oauth.providers.0.slug','oauth.providers.0.active','oauth.providers.0.icon',
'oauth.providers.1.slug','oauth.providers.1.active','oauth.providers.1.icon','oauth.providers.2.slug','oauth.providers.2.active',
'oauth.providers.2.icon','oauth.providers.3.slug','oauth.providers.3.active','oauth.providers.3.icon','oauth.providers.4.slug',
'oauth.providers.4.active','oauth.providers.4.icon','oauth.providers.5.slug','oauth.providers.5.active','oauth.providers.5.icon',
...
'reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','sanctum.stateful','sanctum.guard',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.github.client_id','services.github.client_secret','services.github.redirect',
'services.google.client_id','services.google.client_secret','services.google.redirect','services.x.client_id','services.x.client_secret',
'services.x.redirect','services.gitlab.client_id','services.gitlab.client_secret','services.gitlab.redirect','services.bitbucket.client_id',
'services.bitbucket.client_secret','services.bitbucket.redirect','services.discord.client_id','services.discord.client_secret','services.discord.redirect',
...
'session.partitioned','spy.enabled','spy.table_name','spy.db_connection','spy.exclude_urls',
'spy.obfuscates','spy.obfuscation_mask','spy.clean_days','spy.request_body_exclude_content_types','spy.response_body_exclude_content_types',
'spy.field_max_length','spy.field_max_rows','spy.dashboard.enabled','spy.dashboard.prefix','spy.dashboard.middleware',
...
'view.compiled','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','resend.api_key',
'resend.domain','resend.path','resend.webhook.secret','resend.webhook.tolerance','query-builder.parameters.include',
...
'query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'password.confirmation','password.confirm.store','resend.webhook',
'api.users.current','api.users.roles','api.users.user.index','api.users.user.store','api.users.user.show',
'api.users.user.update','api.users.user.destroy','api.users.all','api.users.active','api.teams.teams.index',
'api.teams.teams.store','api.teams.teams.show','api.teams.teams.update','api.teams.teams.destroy','api.teams.switch',
'api.companies.company.index','api.companies.company.store','api.companies.company.show','api.companies.company.update','api.companies.company.destroy',
'api.projects.project.index','api.projects.project.store','api.projects.project.show','api.projects.project.update','api.projects.project.destroy',
'api.invoices.prerequisites','api.invoices.invoices.preview-pdf','api.invoices.download-pdf','api.invoices.invoices.index','api.invoices.invoices.store',
'api.invoices.invoices.show','api.invoices.invoices.update','api.invoices.invoices.destroy','api.items.items.index','api.items.items.store',
'api.items.items.show','api.items.items.update','api.items.items.destroy','api.payments.payments.index','api.payments.payments.store',
'api.payments.payments.show','api.payments.payments.update','api.payments.payments.destroy','api.customers.customers.index','api.customers.customers.store',
'api.customers.customers.show','api.customers.customers.update','api.customers.customers.destroy','api.permissions.permissions.index','api.permissions.permissions.store',
'api.permissions.permissions.show','api.permissions.permissions.update','api.permissions.permissions.destroy','api.roles.roles.index','api.roles.roles.store',
'api.roles.roles.show','api.roles.roles.update','api.roles.roles.destroy','oauth.redirect',
'oauth.callback','login-link.store','login-link.login','oauth.destroy','storage.local',);
        registerArgumentsSet('views', 
'errors.401','errors.402','errors.403','errors.404','errors.419',
'errors.429','errors.500','errors.503','errors.layout','errors.minimal',
'pdf.invoice','pdf.layout','pdf.partials.address','pdf.partials.footer','pdf.partials.header',
'pdf.partials.items','pdf.partials.notes','pdf.partials.totals','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'pagination::simple-tailwind','pagination::tailwind','spy::dashboard',);
