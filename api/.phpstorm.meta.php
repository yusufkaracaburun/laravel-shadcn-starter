...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\CustomerRepositoryInterface' => \App\Repositories\Concretes\CustomerRepository::class,
            'App\Repositories\Contracts\InvoiceRepositoryInterface' => \App\Repositories\Concretes\InvoiceRepository::class,
            'App\Repositories\Contracts\PaymentRepositoryInterface' => \App\Repositories\Concretes\PaymentRepository::class,
            'App\Repositories\Contracts\PermissionRepositoryInterface' => \App\Repositories\Concretes\PermissionRepository::class,
            'App\Repositories\Contracts\ProductRepositoryInterface' => \App\Repositories\Concretes\ProductRepository::class,
            'App\Repositories\Contracts\ProjectRepositoryInterface' => \App\Repositories\Concretes\ProjectRepository::class,
            'App\Repositories\Contracts\RoleRepositoryInterface' => \App\Repositories\Concretes\RoleRepository::class,
            ...
            'App\Services\Contracts\CustomerServiceInterface' => \App\Services\Concretes\CustomerService::class,
            'App\Services\Contracts\InvoiceServiceInterface' => \App\Services\Concretes\InvoiceService::class,
            'App\Services\Contracts\PaymentServiceInterface' => \App\Services\Concretes\PaymentService::class,
            'App\Services\Contracts\PermissionServiceInterface' => \App\Services\Concretes\PermissionService::class,
            'App\Services\Contracts\ProductServiceInterface' => \App\Services\Concretes\ProductService::class,
            'App\Services\Contracts\ProjectServiceInterface' => \App\Services\Concretes\ProjectService::class,
            'App\Services\Contracts\RoleServiceInterface' => \App\Services\Concretes\RoleService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/yusufkaracaburun/Sites/localhost/laravel/skeleton-1/api/public/storage' => 'string',
            ...
            'logging.channels.pail.driver' => 'string',
            'logging.channels.mail.driver' => 'string',
            'logging.channels.mail.path' => 'string',
            'logging.channels.mail.level' => 'string',
            'logging.channels.mail.days' => 'integer',
            'logging.channels.mail.replace_placeholders' => 'boolean',
            'logging.channels.mail.tap' => 'array',
            ...
            'login-link.enabled' => 'boolean',
            'login-link.rate_limit_attempts' => 'integer',
            'login-link.rate_limit_decay' => 'integer',
            'login-link.expiration_minutes' => 'integer',
            'mail.default' => 'string',
            ...
            'mail-tracker.inject-pixel' => 'boolean',
            'mail-tracker.sent-email-model' => 'string',
            'mail-tracker.track-links' => 'boolean',
            'mail-tracker.expire-days' => 'integer',
            'mail-tracker.route.prefix' => 'string',
            'mail-tracker.route.middleware' => 'array',
            'mail-tracker.redirect-missing-links-to' => 'string',
            'mail-tracker.admin-route.enabled' => 'boolean',
            'mail-tracker.admin-route.prefix' => 'string',
            'mail-tracker.admin-route.middleware' => 'array',
            'mail-tracker.admin-template.name' => 'string',
            'mail-tracker.admin-template.section' => 'string',
            'mail-tracker.emails-per-page' => 'integer',
            'mail-tracker.date-format' => 'string',
            'mail-tracker.connection' => 'NULL',
            'mail-tracker.sns-topic' => 'NULL',
            'mail-tracker.log-content' => 'boolean',
            'mail-tracker.log-content-strategy' => 'string',
            'mail-tracker.tracker-filesystem' => 'NULL',
            'mail-tracker.tracker-filesystem-folder' => 'string',
            'mail-tracker.tracker-queue' => 'NULL',
            'mail-tracker.content-max-size' => 'integer',
            'mail-tracker.search-date-start' => 'NULL',
            'mail-tracker.fallback-event-listeners' => 'array',
            ...
            'money.locale' => 'string',
            'money.defaultCurrency' => 'string',
            'money.defaultFormatter' => 'NULL',
            'money.defaultSerializer' => 'NULL',
            'money.isoCurrenciesPath' => 'string',
            'money.currencies.iso' => 'string',
            'money.currencies.bitcoin' => 'string',
            'money.currencies.custom' => 'array',
            'oauth.providers.0.slug' => 'string',
            'oauth.providers.0.active' => 'boolean',
            'oauth.providers.0.icon' => 'string',
            'oauth.providers.1.slug' => 'string',
            'oauth.providers.1.active' => 'boolean',
            'oauth.providers.1.icon' => 'string',
            'oauth.providers.2.slug' => 'string',
            'oauth.providers.2.active' => 'boolean',
            'oauth.providers.2.icon' => 'string',
            'oauth.providers.3.slug' => 'string',
            'oauth.providers.3.active' => 'boolean',
            'oauth.providers.3.icon' => 'string',
            'oauth.providers.4.slug' => 'string',
            'oauth.providers.4.active' => 'boolean',
            'oauth.providers.4.icon' => 'string',
            'oauth.providers.5.slug' => 'string',
            'oauth.providers.5.active' => 'boolean',
            'oauth.providers.5.icon' => 'string',
            ...
            'services.x.redirect' => 'string',
            'services.gitlab.client_id' => 'string',
            'services.gitlab.client_secret' => 'string',
            'services.gitlab.redirect' => 'string',
            ...
            'spy.enabled' => 'boolean',
            'spy.table_name' => 'string',
            'spy.db_connection' => 'NULL',
            'spy.exclude_urls' => 'array',
            'spy.obfuscates' => 'array',
            'spy.obfuscation_mask' => 'string',
            'spy.clean_days' => 'integer',
            'spy.request_body_exclude_content_types' => 'array',
            'spy.response_body_exclude_content_types' => 'array',
            'spy.field_max_length' => 'integer',
            'spy.field_max_rows' => 'integer',
            'spy.dashboard.enabled' => 'boolean',
            'spy.dashboard.prefix' => 'string',
            'spy.dashboard.middleware' => 'array',
...
'delete','manage','before','restore','forceDelete',
'belongsToSameTeam',);
...
'app.admin_email','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'cache.stores.failover.stores','cache.prefix','cache.default_ttl','concurrency.default','cors.paths',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/yusufkaracaburun/Sites/localhost/laravel/skeleton-1/api/public/storage','fortify.guard',
...
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','ide-helper.filename',
...
'ide-helper.additional_relation_types','ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','logging.default',
...
'logging.channels.single.driver','logging.channels.single.path','logging.channels.single.level','logging.channels.single.replace_placeholders','logging.channels.single.tap',
...
'logging.channels.pail.driver','logging.channels.mail.driver','logging.channels.mail.path','logging.channels.mail.level','logging.channels.mail.days',
'logging.channels.mail.replace_placeholders','logging.channels.mail.tap','logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level',
'logging.channels.browser.days','login-link.enabled','login-link.rate_limit_attempts','login-link.rate_limit_decay','login-link.expiration_minutes',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.reply_to.address','mail.reply_to.name',
'mail-tracker.inject-pixel','mail-tracker.sent-email-model','mail-tracker.track-links','mail-tracker.expire-days','mail-tracker.route.prefix',
'mail-tracker.route.middleware','mail-tracker.redirect-missing-links-to','mail-tracker.admin-route.enabled','mail-tracker.admin-route.prefix','mail-tracker.admin-route.middleware',
'mail-tracker.admin-template.name','mail-tracker.admin-template.section','mail-tracker.emails-per-page','mail-tracker.date-format','mail-tracker.connection',
'mail-tracker.sns-topic','mail-tracker.log-content','mail-tracker.log-content-strategy','mail-tracker.tracker-filesystem','mail-tracker.tracker-filesystem-folder',
'mail-tracker.tracker-queue','mail-tracker.content-max-size','mail-tracker.search-date-start','mail-tracker.fallback-event-listeners','media-library.disk_name',
...
'money.locale','money.defaultCurrency','money.defaultFormatter','money.defaultSerializer','money.isoCurrenciesPath',
'money.currencies.iso','money.currencies.bitcoin','money.currencies.custom','oauth.providers.0.slug','oauth.providers.0.active',
'oauth.providers.0.icon','oauth.providers.1.slug','oauth.providers.1.active','oauth.providers.1.icon','oauth.providers.2.slug',
'oauth.providers.2.active','oauth.providers.2.icon','oauth.providers.3.slug','oauth.providers.3.active','oauth.providers.3.icon',
'oauth.providers.4.slug','oauth.providers.4.active','oauth.providers.4.icon','oauth.providers.5.slug','oauth.providers.5.active',
'oauth.providers.5.icon','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting','octane.listeners.Laravel\\Octane\\Events\\RequestReceived',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.github.client_id','services.github.client_secret',
'services.github.redirect','services.google.client_id','services.google.client_secret','services.google.redirect','services.x.client_id',
'services.x.client_secret','services.x.redirect','services.gitlab.client_id','services.gitlab.client_secret','services.gitlab.redirect',
'services.bitbucket.client_id','services.bitbucket.client_secret','services.bitbucket.redirect','services.discord.client_id','services.discord.client_secret',
'services.discord.redirect','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','spy.enabled','spy.table_name','spy.db_connection',
'spy.exclude_urls','spy.obfuscates','spy.obfuscation_mask','spy.clean_days','spy.request_body_exclude_content_types',
'spy.response_body_exclude_content_types','spy.field_max_length','spy.field_max_rows','spy.dashboard.enabled','spy.dashboard.prefix',
'spy.dashboard.middleware','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'view.paths','view.compiled','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains',
...
'query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','tinker.commands','tinker.alias',
'tinker.dont_alias',);
...
'role_or_permission','team','cache.response',);
        registerArgumentsSet('routes', 
'mailTracker_t','mailTracker_n','mailTracker_SNS','mailTracker_Index','mailTracker_Search',
'mailTracker_ClearSearch','mailTracker_ShowEmail','mailTracker_UrlDetail','mailTracker_SmtpDetail','boost.browser-logs',
...
'password.confirm.store','resend.webhook','api.users.prerequisites',
'api.users.all','api.users.active','api.users.current','api.users.roles','api.users.users.index',
'api.users.users.store','api.users.users.show','api.users.users.update','api.users.users.destroy','api.teams.prerequisites',
'api.teams.switch','api.teams.teams.index','api.teams.teams.store','api.teams.teams.show','api.teams.teams.update',
'api.teams.teams.destroy','api.projects.project.index','api.projects.project.store','api.projects.project.show','api.projects.project.update',
'api.projects.project.destroy','api.invoices.prerequisites','api.invoices.invoices.preview-pdf','api.invoices.download-pdf','api.invoices.invoices.index',
'api.invoices.invoices.store','api.invoices.invoices.show','api.invoices.invoices.update','api.invoices.invoices.destroy','api.products.products.index',
'api.products.products.store','api.products.products.show','api.products.products.update','api.products.products.destroy','api.payments.payments.index',
...
'api.roles.roles.store','api.roles.roles.show','api.roles.roles.update','api.roles.roles.destroy','api.vehicles.prerequisites',
'api.vehicles.all','api.vehicles.active','api.vehicles.vehicles.index','api.vehicles.vehicles.store','api.vehicles.vehicles.show',
'api.vehicles.vehicles.update','api.vehicles.vehicles.destroy','api.equipments.prerequisites','api.equipments.all','api.equipments.active',
'api.equipments.equipments.index','api.equipments.equipments.store','api.equipments.equipments.show','api.equipments.equipments.update','api.equipments.equipments.destroy',
'api.timesheets.prerequisites','api.timesheets.all','api.timesheets.active','api.timesheets.timesheets.index','api.timesheets.timesheets.store',
'api.timesheets.timesheets.show','api.timesheets.timesheets.update','api.timesheets.timesheets.destroy','oauth.redirect',
'oauth.callback','login-link.store','login-link.login','oauth.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'emailTrakingViews::emails.mensaje','emailTrakingViews::emails.mensaje_layout','emailTrakingViews::index','emailTrakingViews::layouts.app','emailTrakingViews::show',
'emailTrakingViews::smtp_detail','emailTrakingViews::url_detail','emails.invoices.sent','errors.401','errors.402',
'errors.403','errors.404','errors.419','errors.429','errors.500',
'errors.503','errors.layout','errors.minimal','pdf.invoice','pdf.layout',
'pdf.partials.address','pdf.partials.footer','pdf.partials.header','pdf.partials.items','pdf.partials.notes',
'pdf.partials.totals','vendor.emailTrakingViews.emails.mensaje','vendor.emailTrakingViews.emails.mensaje_layout','vendor.emailTrakingViews.index','vendor.emailTrakingViews.layouts.app',
'vendor.emailTrakingViews.show','vendor.emailTrakingViews.smtp_detail','vendor.emailTrakingViews.url_detail','vendor.mail.html.button','vendor.mail.html.footer',
...
'vendor.mail.text.message','vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','emailTrakingViews::emails.mensaje',
'emailTrakingViews::emails.mensaje_layout','emailTrakingViews::index','emailTrakingViews::layouts.app','emailTrakingViews::show','emailTrakingViews::smtp_detail',
'emailTrakingViews::url_detail','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'FRONTEND_URL','ADMIN_EMAIL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
'APP_MAINTENANCE_DRIVER','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
'LOG_LEVEL','DB_CONNECTION','DB_LOG_QUERIES','SESSION_DRIVER','SESSION_LIFETIME',
'SESSION_ENCRYPT','SESSION_PATH','SESSION_SAME_SITE','SESSION_SECURE_COOKIE','SESSION_DOMAIN',
'SANCTUM_STATEFUL_DOMAINS','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','CACHE_PREFIX',
'CACHE_DEFAULT_TTL','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD',
'REDIS_PORT','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','RESEND_API_KEY',
'AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT',
'VITE_APP_NAME','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',
'GITLAB_CLIENT_ID','GITLAB_CLIENT_SECRET','STRIPE_KEY','STRIPE_SECRET','STRIPE_WEBHOOK_SECRET',
'SENTRY_LARAVEL_DSN','GEMINI_API_KEY','BROADCAST_CONNECTION','REVERB_APP_ID','REVERB_APP_KEY',
'REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME','VITE_REVERB_APP_KEY',
'VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','SLACK_WEBHOOK_URL','OPENAI_API_KEY',
'TRANSLATION_DEFAULT_DRIVER','TRANSLATION_SOURCE_LANGUAGE','CHATGPT_API_KEY','GOOGLE_API_KEY','DEEPL_API_KEY',
'ANTHROPIC_API_KEY','PHONE_DEFAULT_REGION','QUERY_DETECTOR_ENABLED','QUERY_DETECTOR_THRESHOLD','QUERY_DETECTOR_LOG_CHANNEL',);
