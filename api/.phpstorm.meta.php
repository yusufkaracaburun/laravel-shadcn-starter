...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail-tracker.inject-pixel','mail-tracker.sent-email-model',
'mail-tracker.track-links','mail-tracker.expire-days','mail-tracker.route.prefix','mail-tracker.route.middleware','mail-tracker.redirect-missing-links-to',
'mail-tracker.admin-route.enabled','mail-tracker.admin-route.prefix','mail-tracker.admin-route.middleware','mail-tracker.admin-template.name','mail-tracker.admin-template.section',
'mail-tracker.emails-per-page','mail-tracker.date-format','mail-tracker.connection','mail-tracker.sns-topic','mail-tracker.log-content',
'mail-tracker.log-content-strategy','mail-tracker.tracker-filesystem','mail-tracker.tracker-filesystem-folder','mail-tracker.tracker-queue','mail-tracker.content-max-size',
'mail-tracker.search-date-start','mail-tracker.fallback-event-listeners','media-library.disk_name','media-library.max_file_size','media-library.queue_connection_name',
...
'media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','money.locale','money.defaultCurrency',
'money.defaultFormatter','money.defaultSerializer','money.isoCurrenciesPath','money.currencies.iso','money.currencies.bitcoin',
'money.currencies.custom','oauth.providers.0.slug','oauth.providers.0.active','oauth.providers.0.icon','oauth.providers.1.slug',
'oauth.providers.1.active','oauth.providers.1.icon','oauth.providers.2.slug','oauth.providers.2.active','oauth.providers.2.icon',
'oauth.providers.3.slug','oauth.providers.3.active','oauth.providers.3.icon','oauth.providers.4.slug','oauth.providers.4.active',
'oauth.providers.4.icon','oauth.providers.5.slug','oauth.providers.5.active','oauth.providers.5.icon','octane.server',
...
'octane.max_execution_time','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'services.slack.notifications.channel','services.github.client_id','services.github.client_secret','services.github.redirect','services.google.client_id',
'services.google.client_secret','services.google.redirect','services.x.client_id','services.x.client_secret','services.x.redirect',
'services.gitlab.client_id','services.gitlab.client_secret','services.gitlab.redirect','services.bitbucket.client_id','services.bitbucket.client_secret',
'services.bitbucket.redirect','services.discord.client_id','services.discord.client_secret','services.discord.redirect','session.driver',
...
'spy.enabled','spy.table_name','spy.db_connection','spy.exclude_urls','spy.obfuscates',
'spy.obfuscation_mask','spy.clean_days','spy.request_body_exclude_content_types','spy.response_body_exclude_content_types','spy.field_max_length',
'spy.field_max_rows','spy.dashboard.enabled','spy.dashboard.prefix','spy.dashboard.middleware','telescope.enabled',
...
'boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','resend.api_key','resend.domain',
'resend.path','resend.webhook.secret','resend.webhook.tolerance','query-builder.parameters.include','query-builder.parameters.filter',
...
'query-builder.convert_field_names_to_snake_case','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'vendor.emailTrakingViews.show','vendor.emailTrakingViews.smtp_detail','vendor.emailTrakingViews.url_detail','emailTrakingViews::emails.mensaje','emailTrakingViews::emails.mensaje_layout',
'emailTrakingViews::index','emailTrakingViews::layouts.app','emailTrakingViews::show','emailTrakingViews::smtp_detail','emailTrakingViews::url_detail',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','spy::dashboard',);
