...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','tinker.commands',
...
'sanctum.csrf-cookie','telescope','api.user.current','user.index','user.store','user.show',
'user.update','user.destroy','teams.index','teams.store','teams.show',
'teams.update','teams.destroy','api.teams.switch','oauth.redirect',
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','RESEND_KEY','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','OCTANE_SERVER',);
