...
'two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','api.users.current','api.users.user.index','api.users.user.store',
'api.users.user.show','api.users.user.update','api.users.user.destroy','api.teams.teams.index','api.teams.teams.store',
'api.teams.teams.show','api.teams.teams.update','api.teams.teams.destroy','api.teams.switch',
