...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/yusufkaracaburun/Sites/localhost/laravel/skeleton-1/api/public/storage','fortify.guard','fortify.middleware',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','logging.default','logging.deprecations.channel',
...
'logging.channels.single.path','logging.channels.single.level','logging.channels.single.replace_placeholders','logging.channels.single.tap','logging.channels.daily.driver',
'logging.channels.daily.path','logging.channels.daily.level','logging.channels.daily.days','logging.channels.daily.replace_placeholders','logging.channels.daily.tap',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.pail.driver',
'logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','login-link.enabled',
'login-link.rate_limit_attempts','login-link.rate_limit_decay','login-link.expiration_minutes','mail.default','mail.mailers.smtp.transport',
...
'media-library.prefix','media-library.force_lazy_loading','money.locale','money.defaultCurrency','money.defaultFormatter',
'money.defaultSerializer','money.isoCurrenciesPath','money.currencies.iso','money.currencies.bitcoin','money.currencies.custom',
'oauth.providers.0.slug','oauth.providers.0.active','oauth.providers.0.icon','oauth.providers.1.slug','oauth.providers.1.active',
'oauth.providers.1.icon','oauth.providers.2.slug','oauth.providers.2.active','oauth.providers.2.icon','oauth.providers.3.slug',
'oauth.providers.3.active','oauth.providers.3.icon','oauth.providers.4.slug','oauth.providers.4.active','oauth.providers.4.icon',
'oauth.providers.5.slug','oauth.providers.5.active','oauth.providers.5.icon','octane.server','octane.https',
...
'services.google.redirect','services.x.client_id','services.x.client_secret','services.x.redirect','services.gitlab.client_id',
'services.gitlab.client_secret','services.gitlab.redirect','services.bitbucket.client_id','services.bitbucket.client_secret','services.bitbucket.redirect',
'services.discord.client_id','services.discord.client_secret','services.discord.redirect','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','spy.enabled',
'spy.table_name','spy.db_connection','spy.exclude_urls','spy.obfuscates','spy.obfuscation_mask',
'spy.clean_days','spy.request_body_exclude_content_types','spy.response_body_exclude_content_types','spy.field_max_length','spy.field_max_rows',
'spy.dashboard.enabled','spy.dashboard.prefix','spy.dashboard.middleware','telescope.enabled','telescope.domain',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','view.paths','view.compiled','dompdf.show_warnings',
...
'api.invoices.invoices.index','api.invoices.invoices.store','api.invoices.invoices.show','api.invoices.invoices.update','api.invoices.invoices.destroy',
'api.items.items.index','api.items.items.store','api.items.items.show','api.items.items.update','api.items.items.destroy',
'api.payments.payments.index','api.payments.payments.store','api.payments.payments.show','api.payments.payments.update','api.payments.payments.destroy',
'api.customers.customers.index','api.customers.customers.store','api.customers.customers.show','api.customers.customers.update','api.customers.customers.destroy',
'api.permissions.permissions.index','api.permissions.permissions.store','api.permissions.permissions.show','api.permissions.permissions.update','api.permissions.permissions.destroy',
'api.roles.roles.index','api.roles.roles.store','api.roles.roles.show','api.roles.roles.update','api.roles.roles.destroy','oauth.redirect','oauth.callback','login-link.store','login-link.login',
'oauth.destroy','storage.local',);
